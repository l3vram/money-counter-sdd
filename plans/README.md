...
| 034 | `034-offline-session` | Sesión offline que sobrevive + un 401 que expulsa + indicador de "sin conexión" | P1 | M | 033 | 🔄 pasos 1–5 DONE en `plan/034` (505 tests) — **paso 6 (dispositivo) pendiente del dueño** |
